            ...
            <div className='container text-white py-5'>
                <div className='row'>
                    <div className='col-sm-12 col-md-4 text-center text-md-start'>
                        ...
                        <Link to="/login" className='text-decoration-none text-danger'>
                            ...
                            <Link to="/courses" className='text-decoration-none text-danger'>
                                <li className='text-uppercase fw-semibold my-2'>Our Courses</li>
                            </Link>

                            <Link to="/affiliatedcolleges" className='text-decoration-none text-danger'>
                                <li className='text-uppercase fw-semibold my-2'>Affalliated Colleges</li>
                            </Link>
                    ...
                    <div className='col-sm-12 col-md-4 d-flex flex-column align-items-center '>
                        ...
                        <ul className='footer-social-icons list-unstyled d-flex justify-content-center my-4' >
                            <Link to="/contact">
                                <li className='mx-4'>
                                    {/* facebook icon */}
                        ...
                        <ul className='footer-social-icons list-unstyled d-flex justify-content-center' >
                            <Link to="/contact">
                                <li className='mx-4'>
                                    {/* youtube icon */}
                    ...
                    <div className='col-sm-12 col-md-4 d-flex flex-column text-center text-md-start'>
                        <h3>GET IN TOUCH</h3>
                        <div className='text-light mt-2 mt-md-4 '>
                            <p className='my-0 py-2'>Main Address - 47 street Name, Lahore Pakistan</p>
                            <p className='my-0 py-2'>Phone Number - 03123456789</p>
                            <p className='my-0 py-2'>Email - react@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className=' bg-white'>
                <p className='p-1 m-0 text-center'>Copyright @ 2024 Code Cedits. All rights reserved</p>
            </div>
        </footer>
    )
}
